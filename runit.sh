...
${EXEPATH}/bankcheck totals ~/Dropbox/LPSM/personal/visa/20190701.csv "$@"
#${EXEPATH}/bankcheck totals ~/Dropbox/LPSM/personal/visa/20190401.csv ~/Dropbox/LPSM/personal/visa/20190701.csv "$@"
#${EXEPATH}/bankcheck totals ~/Dropbox/LPSM/personal/visa/*.csv "$@"
